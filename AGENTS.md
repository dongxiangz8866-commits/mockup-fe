...
The parent file at `../AGENTS.md` defines the wider workspace standards and applies here:
...
No code yet — no scripts to document. When the first prototype is scaffolded (likely `pnpm create vite` + pixi.js or react-three-fiber), record its commands here.
